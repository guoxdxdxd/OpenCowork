...
<Cards>
  <Card
    ...
    description="了解 OpenCowork 的核心特性并完成安装"
  />
  <Card
    title="核心概念"
    href="/docs/core-concepts/agent-loop"
    description="深入理解 Agent 循环与工具系统"
  />
  <Card
    title="功能特性"
    href="/docs/features/chat-modes"
    description="探索聊天模式、子代理、团队协作"
  />
  <Card title="插件系统" href="/docs/plugins/overview" description="配置消息平台自动回复" />
  <Card
    title="AI 提供商"
    href="/docs/providers/overview"
    description="配置 Claude、GPT、DeepSeek 等模型"
  />
  <Card
    title="架构设计"
    href="/docs/architecture/overview"
    description="了解 Electron 进程模型与数据库设计"
  />
</Cards>
